...
skip = False
for line in lines:
    if "@app.route('/content')" in line or "@app.route('/api/edit-post" in line or "@app.route('/api/delete-post" in line:
        skip = True
...
# Append clean, non-duplicate routes right before if __name__ == '__main__':
content_routes = """
@app.route('/content')
def content_manager():
...
print("Cleaned and updated app.py successfully!")
