...
# 1. Safely add routes to app.py without conflicts
...
if "@app.route('/content')" not in app_code:
    ...
    with open('app.py', 'w') as f:
        f.write(app_code)
    print("Added Content routes to app.py successfully!")

# 2. Inject Content Hub EXACTLY before Analytics in the footer
